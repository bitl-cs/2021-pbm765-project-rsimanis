...
#define PACKET_ACCEPT_STATUS_SUCCESS        0
...
#define PACKET_RETURN_TO_JOIN_ID            13
#define PACKET_RETURN_TO_JOIN_SIZE          (PACKET_HEADER_SIZE + PACKET_RETURN_TO_MENU_DATA_SIZE + PACKET_FOOTER_SIZE)
#define PACKET_RETURN_TO_JOIN_DATA_SIZE     0
