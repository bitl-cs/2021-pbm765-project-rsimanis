...
CFLAGS = -std=gnu90 -Wall -fno-common
...
_LIB_GRAPHICS_OBJS = pong_graphics_general.o pong_graphics_game.o pong_graphics_join.o pong_graphics_lobby.o pong_graphics_menu.o pong_graphics_statistics.o pong_graphics.o
